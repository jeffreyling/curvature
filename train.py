...
parser.add_argument('--random-labels', dest='random_labels', action='store_true',
                    help='set labels to be random')
...
def main():
   ...
   # optionally resume from a checkpoint
    ...
    if args.random_labels:
        random_labels(train_loader, num_labels=10)
        random_labels(val_loader, num_labels=10)
